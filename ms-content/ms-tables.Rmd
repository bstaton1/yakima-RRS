...
formulae = unlist(lapply(best_models, function(m) format_formula(m)$cond)) |> 
  ...
  stringr::str_replace_all("Pa_length", "male length") |> 
  stringr::str_replace_all("Ma_length", "female length") |> 
...
tab = data.frame(
  Analysis = c(
    ...
    "Per Capita Productivity (1-Gen)",
    "Per Capita Productivity (2-Gen)"),

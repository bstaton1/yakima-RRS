...
mtext(side = 2, line = 1.5, text = RS_name("cond", grand = FALSE, is_RRS = TRUE), cex = 0.9)
mtext(side = 3, line = 1.5, "One Generation", font = 2)
compare_RRS_plot(RRS_summ_1gen, RS_type = "nzprb", ylim = ylim)
mtext(side = 2, line = 1.5, text = RS_name("nzprb", grand = FALSE, is_RRS = TRUE), cex = 0.9)
compare_RRS_plot(RRS_summ_1gen, RS_type = "resp", ylim = ylim)
mtext(side = 2, line = 1.5, text = RS_name("resp", grand = FALSE, is_RRS = TRUE), cex = 0.9)
...
mtext(side = 4, line = 0.75, text = RS_name("nzprb", grand = TRUE, is_RRS = TRUE), cex = 0.9)
compare_RRS_plot(RRS_summ_2gen, RS_type = "resp", ylim = ylim, yaxis_side = 2)
mtext(side = 4, line = 0.75, text = RS_name("resp", grand = TRUE, is_RRS = TRUE), cex = 0.9)

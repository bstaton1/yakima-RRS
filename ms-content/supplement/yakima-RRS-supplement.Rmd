...
author: |
    | <small>**Authors**: I.J. Koch, B.A. Staton, H.M. Nuetzel, T.R. Seamons, A.P. Matala, K.I. Warheit, M.V. Johnston, C.R. Strom, S.R. Narum, and W.J. Bosch</small>
    | <small>**Article DOI**: [10.1139/cjfas-2024-0289](https://doi.org/10.1139/cjfas-2024-0289)</small>
output:
  html_document
params:
  output_subdir: 
...
no_HOR_percapita_prod_footnote_text = "The research question was focused on comparing productivity of fish spawned in the hatchery vs. in the wild. To remove potential confounding effects of recent ancestry, we used only NOR fish for this analysis; further, only NOR fish are used as broodstock."

# add these to the list of protected objects
protect = c(protect, "no_broodstock_footnote", "no_F1_broodstock_footnote", "no_HOR_percapita_prod_footnote_text")
```
...
_Larger numbers in cells are point estimates and smaller numbers in parentheses are 95% bootstrap confidence intervals._
_Gray cells have confidence intervals that overlap 1, thus lack statistical evidence for a difference in reproductive success._
</details>
:::
...
_The numerator in the RRS ratio is shown as the column header and in all cases the denominator is NORxNOR._
_Larger numbers in cells are point estimates and smaller numbers in parentheses are 95% bootstrap confidence intervals._
_Gray cells have confidence intervals that overlap 1, thus lack statistical evidence for a difference in reproductive success._
</details>
:::
...
<details>
<summary>`r shiny::icon("info-circle")` **Description**</summary>
_Hurdle model-predicted values of reproductive success (RS) and relative reproductive success (RRS) ratios by year, sex, life stage, and acclimation site._
_The numerator in the RRS ratio is shown as the column header and in all cases the denominator is Clark Flat._
_Larger numbers in cells are point estimates and smaller numbers in parentheses are 95% bootstrap confidence intervals._
_Gray cells have confidence intervals that overlap 1, thus lack statistical evidence for a difference in reproductive success._
</details>
:::
...
```{r 04-rs-v-cont-day, child = file.path(supp_dir, "relationship-figs-supp-template.Rmd")}
```
...
<details>
<summary>`r shiny::icon("info-circle")` **Description**</summary>
_Hurdle model-predicted values of reproductive success (RS) by year, sex, life stage, and acclimation site._
_Error bars represent 95% bootstrap confidence intervals._
...
<details>
<summary>`r shiny::icon("info-circle")` **Description**</summary>
_Relative reproductive success (RRS) ratios from hurdle model-predicted values by year, sex, life stage and acclimation site._
_Error bars represent 95% bootstrap confidence intervals._
_Values shown here are identical to those in Table S10._
</details>
:::
...
<details>
<summary>`r shiny::icon("info-circle")` **Description**</summary>
_Hurdle model-predicted values of reproductive success (RS) and relative reproductive success (RRS) ratios by year, sex, and ancestry._
_The numerator in the RRS ratio is shown as the column header and in all cases the denominator is NORxNOR._
_Larger numbers in cells are point estimates and smaller numbers in parentheses are 95% bootstrap confidence intervals._
_Gray cells have confidence intervals that overlap 1, thus lack statistical evidence for a difference in reproductive success._
</details>
...
<details>
<summary>`r shiny::icon("info-circle")` **Description**</summary>
_Hurdle model-predicted values of reproductive success (RS) by year, sex, and ancestry._
_Error bars represent 95% bootstrap confidence intervals._
...
## Per Capita Productivity<small> 1-Gen </small> {.tabset}
...
# -> loads data                      ##
# -> loads any existing output files ##
rm(out_dir); source("06-1gen-percapita-prod/06-00-setup.R")
...
desc_table(
  ...
  footnote_text = c(no_HOR_percapita_prod_footnote_text)
)
```
...
out = percapita_prod_sample_size_table_one(dat = dat, keep_sex = "M", keep_life_stage = "Jack") |> 
  merge(percapita_prod_sample_size_table_one(dat, keep_sex = "M", keep_life_stage = "Adult"), by = "year") |> 
  merge(percapita_prod_sample_size_table_one(dat, keep_sex = "F", keep_life_stage = "Adult"), by = "year")
...
### Table S`r tab_id = tab_id+1; tab_id` <small>_RS & PCP_</small> {.tabset .tabset-pills}

:::{.helptext}
<details>
<summary>`r shiny::icon("info-circle")` **Description**</summary>
_Hurdle model-predicted values of reproductive success (RS) and per capita productivity (PCP) ratios by year, disposition (broodstock vs. natural spawning), sex, and life stage._
_The numerator in the PCP ratio is shown as the column header._
_Larger numbers in cells are point estimates and smaller numbers in parentheses are 95% bootstrap confidence intervals._
_Gray cells have confidence intervals that overlap 1, thus lack statistical evidence for a difference in reproductive success._
</details>
:::
...
_Error bars represent 95% bootstrap confidence intervals._
_Values shown here are identical to those in Table S15._
</details>
:::
...
## Per Capita Productivity <small> 2-Gen </small> {.tabset}
...
# -> loads data                      ##
# -> loads any existing output files ##
rm(out_dir); source("07-2gen-percapita-prod/07-00-setup.R")
...
desc_table(
  ...
  footnote_text = c(no_F1_broodstock_footnote, no_HOR_percapita_prod_footnote_text)
)
```
...
_Hurdle model-predicted values of reproductive success (RS) by year, disposition (broodstock vs. natural spawning), sex, and life stage._
_Error bars represent 95% bootstrap confidence intervals._
_Values shown here are identical to those in Table S18._
</details>
:::

...
_QSRs are on the interval [0,1] and represent the quantile of the observed value from the predictive distribution -- 'DHARMa' uses simulation to build this predictive distribution for evaluating the empirical cumulative probability density function._

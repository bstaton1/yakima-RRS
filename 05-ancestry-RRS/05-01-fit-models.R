...
formulae = list(
  ...
  ~ ancestry * year * sex + length * sex,
  ~ ancestry * year * sex + length * life_stage,
  ~ ancestry * year * sex + length * sex + length * life_stage,
  ~ ancestry * year * sex + day,
  ~ ancestry * year * sex + day * sex,
  ~ ancestry * year * sex + day + I(day^2),
  ~ ancestry * year * sex + day * sex + I(day^2),
  ...
  ~ ancestry * year * sex + length * sex + length * life_stage + day * sex + I(day^2),
  ~ ancestry * year * sex + length * sex + length * life_stage + day * year + day * sex + I(day^2),
  ~ ancestry * year * sex + length * sex + length * life_stage + day * sex + I(day^2) * year,
  ~ ancestry * year * sex + length * sex + length * life_stage + day * year + day * sex + I(day^2) * year,
  ~ year * sex,
  ~ year * sex + life_stage,
  ~ year * sex + length,
  ~ year * sex + length * sex,
  ...
  ~ year * sex + length * sex + length * life_stage + day * year + day * sex + I(day^2),
  ~ year * sex + length * sex + length * life_stage + day * sex + I(day^2) * year,
  ~ year * sex + length * sex + length * life_stage + day * year + day * sex + I(day^2) * year
)

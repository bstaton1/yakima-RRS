...
formulae = list(
  ...
  ~ year * sex + F1 * sex * origin,
  ~ year * sex + F1 * sex * year,
  ~ year * sex + length * life_stage,
  ~ year * sex + length * sex + length * life_stage,
  ~ year * sex + length * life_stage + F1,
  ~ year * sex + length * sex +length * life_stage + F1,
  ~ year * sex + length * life_stage + F1 * origin,
  ~ year * sex + length * sex + length * life_stage + F1 * origin,
  ~ year * sex + day,
  ~ year * sex + day * sex,
  ~ year * sex + day + I(day^2),
  ~ year * sex + day * sex + I(day^2),
  ~ year * sex + day + I(day^2) + F1,
  ~ year * sex + day * sex + I(day^2) + F1,
  ~ year * sex + length * life_stage + day + I(day^2),
  ~ year * sex + length * sex + length * life_stage + day + I(day^2),
